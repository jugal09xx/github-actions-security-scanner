...
//Welcome
console.log(chalk.black.bgGreenBright("Welcome to Github Actions Security Scanner!"));
console.log(chalk.yellow.italic("A tool to scan Github Actions (.yml) files for malicious content"));
console.log();
